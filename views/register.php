            ...
            <div class="card w-25 my-auto mx-auto">
                ...
                <div class="card-body">
                    <form action="../actions/register-action.php" method="post">
                        <div class="mb-3">
                            <label for="first-name" class="form-label fw-bold">Firstname</label>
                            <input type="text" name="first_name" id="first-name" class="form-control" required autofocus>
                        </div>
                        <div class="mb-3">
                            <label for="last-name" class="form-label fw-bold">Lastname</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="username" id="username" class="form-control fw-bold" max-length="15" required>
                        </div>
                        <div class="mb-5">
